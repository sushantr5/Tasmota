...
be_local_class(Matter_UI,
    ...
    ( (struct bmapnode*) &(const bmapnode[]) {
        ...
        { be_const_key_weak(_CLASSES_TYPES, 2), be_nested_str_weak(_X7Crelay_X7Clight0_X7Clight1_X7Clight2_X7Clight3_X7Cshutter_X7Cshutter_X2Btilt_X7Ctemperature_X7Cpressure_X7Cilluminance_X7Chumidity_X7Cfan) },
